...
class InitAgents(IInitAgents):
    ...
    def getAgents(self):
        __disp = False
        agents = [
            MsgClassifyAgentWrapper(self._agent_class(0, 0, [0], disp=__disp)),
            ...
            MsgClassifyAgentWrapper(self._agent_class(4, 0, [0], disp=__disp)),
            MsgClassifyAgentWrapper(self._agent_class(5, 0, [0], disp=__disp)),
            MsgClassifyAgentWrapper(self._agent_class(6, 0, [0], disp=__disp)),
            MsgClassifyAgentWrapper(self._agent_class(7, 0, [0], disp=__disp)),
            MsgClassifyAgentWrapper(self._agent_class(8, 0, [0], disp=__disp)),
            MsgClassifyAgentWrapper(self._agent_class(9, 0, [0], disp=__disp)),
            MsgClassifyAgentWrapper(self._agent_class(10, 0, [0], disp=__disp)),
        ]
        return agents