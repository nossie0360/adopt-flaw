    ...
    def exec(self, agents: list[MsgClassifyAgentWrapper], functions: list[Function]) -> list[int]:
        ...
        while True:
            ...
            while not all(terminated):
                ...
                if time - 1 < len(process_sequence):
                    process_idx = time - 1
                ...
                for agent in agents:
                    ...
                    # reversed to make agents[3] receive agents[1]'s message earlier than agents[2]'s.
                    # this is required for termination.
                    target_list = sorted(agent.getInvolvedAgentsId(), reverse=True)
