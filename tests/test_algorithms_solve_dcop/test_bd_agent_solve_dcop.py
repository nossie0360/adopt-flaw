...
from src.module.agents.bd_adopt.bd_agent import BdAgent
...
class TestBdAgentSolveDcop(unittest.TestCase):
    def setUp(self):
        self.agent_class = BdAgent

    # NOTE: BD-ADOPT fails to solve this problem!!
