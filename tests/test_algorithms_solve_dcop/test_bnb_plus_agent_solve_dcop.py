...
from src.module.agents.bnb_adopt_plus.bnb_plus_agent import BnbPlusAgent
...
class TestBnbPlusAgentSolveDcop(unittest.TestCase):
    def setUp(self):
        self.agent_class = BnbPlusAgent

    # NOTE: BnB-ADOPT+ fails to solve this problem!!
